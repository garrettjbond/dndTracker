...
const CombatTips = () => {
    return (
        <div id="combat-section" className="mx-5 h-fit flex flex-col">
            ...
            <div>
                <div>
                    <h3 className="text-6xl font-bold font-['Permanent\\ Marker'] text-left px-6">0<span className="bg-gradient-to-l from-red-400 to-red-200 text-transparent bg-clip-text">1</span></h3>
                ...
                <div className="flex flex-col items-end">
                    <h3 className="text-6xl font-bold font-['Permanent\\ Marker'] text-right px-6">0<span className="bg-gradient-to-l from-red-400 to-red-200 text-transparent bg-clip-text">2</span></h3>
                    <div className="rounded-2xl w-4/5 drop-shadow-md bg-lightgrey px-6 py-3 flex flex-col text-left -mt-2">
                ...
                <div>
                    <h3 className="text-6xl font-bold font-['Permanent\\ Marker'] text-left px-6">0<span className="bg-gradient-to-l from-red-400 to-red-200 text-transparent bg-clip-text">3</span></h3>
                    <div className="rounded-2xl w-4/5 drop-shadow-md bg-lightgrey px-6 py-3 flex flex-col text-left -mt-2">
                ...
                <div className="flex flex-col items-end">
                    <h3 className="text-6xl font-bold font-['Permanent\\ Marker'] text-right px-6">0<span className="bg-gradient-to-l from-red-400 to-red-200 text-transparent bg-clip-text">4</span></h3>
                    <div className="rounded-2xl w-4/5 drop-shadow-md bg-lightgrey px-6 py-3 flex flex-col text-left -mt-2">
