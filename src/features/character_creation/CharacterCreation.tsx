...
const CharacterCreation = () => {
    ...
    return (
        <div id="character-section" className="h-screen m-5 flex flex-col justify-start pt-10 gap-18">
            ...
            <div className="flex flex-col justify-start gap-10 items-center h-fit">
                <form className="flex flex-col items-center gap-12 md:gap-15" onSubmit={addToRoster}>
